...
test.describe('Game Listing and Navigation', () => {
  ...
  test('should navigate between paginated game-list pages', async ({ page }) => {
    await test.step('Navigate to the first game-list page', async () => {
      await page.goto('/');
    ...
    await test.step('Open the second game-list page', async () => {
    ...
    await test.step('Return to the first game-list page', async () => {
